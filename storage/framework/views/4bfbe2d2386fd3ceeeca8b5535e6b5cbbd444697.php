...
<body>
  ...
  <div class="container py-3">
    <div class="row">
      <div class="col-md-8 offset-md-2">
        <form method="POST" action="<?php echo e(route('registerUser')); ?>" enctype="multipart/form-data">
  ...
  <script type="text/javascript">
    ...
    /body> <
    /html>
<?php /**PATH C:\Apache24\htdocs\bulletinBoard_PHP\resources\views/auth/register.blade.php ENDPATH**/ ?>