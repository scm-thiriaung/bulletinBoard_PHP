      ...
      <div class="col-md-8 offset-md-2">
        <div class="card">
          <div class="card-body">
            ...
            <?php echo e($post[0]->title); ?>

          </div>
          <div class="card-body">
            <b style="font-size:20px;">Description</b>
            <?php echo e($post[0]->description); ?>
          ...
          <a href="<?php echo e(route('post.index')); ?>" class="btn btnBack my-sm-0"
...
<?php /**PATH C:\Apache24\htdocs\bulletinBoard_PHP\resources\views/post/postDetail.blade.php ENDPATH**/ ?>